...
#define MPEG4_DEC_GETCONF_MPEG4_FCODE				0x00001005
#define MPEG4_DEC_GETCONF_MPEG4_VOP_TIME_RES		0x00001006
#define MPEG4_DEC_GETCONF_MPEG4_TIME_BASE_LAST		0x00001007
#define MPEG4_DEC_GETCONF_MPEG4_NONB_TIME_LAST		0x00001008
#define MPEG4_DEC_GETCONF_MPEG4_TRD					0x00001009
#define MPEG4_DEC_GETCONF_PHYADDR_B_FRAM_BUF		0x00001010
#define MPEG4_DEC_GETCONF_BYTE_CONSUMED				0x00001011
...
void *SsbSipMPEG4DecodeGetBFrameBuf(void *openHandle, long size);
void SsbSipMPEG4CacheFlushBFrame(void *openHandle);
