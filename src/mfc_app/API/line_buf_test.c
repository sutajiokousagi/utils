...
int Test_H263_Decoder_Line_Buffer(int argc, char **argv)
{
	...
	////////////////////////////////////
	nFrameLeng = ExtractConfigStreamH263(pFrameExCtx, &file_strm, pStrmBuf, INPUT_BUFFER_SIZE, NULL);
	...
	while(1) {
		...
		// Next H.264 VIDEO stream //
		/////////////////////////////
		nFrameLeng = NextFrameH263(pFrameExCtx, &file_strm, pStrmBuf, INPUT_BUFFER_SIZE, NULL);
		if (nFrameLeng < 4)
			break;
	}
