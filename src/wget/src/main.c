...
struct cmdline_option option_data[] =
  {
    ...
    { "progressbar", 0, OPT_BOOLEAN, "progressbar", -1 }, // ken@chumby.com
    { "writefpevent", 0, OPT_BOOLEAN, "writefpevent", -1 }, // ken@chumby.com
...
Download:\n"),
  ...
  -c,  --continue                resume getting a partially-downloaded file.\n"),
    ...
    N_("\
       --progressbar             write red progress bar to frame buffer.\n"),
    N_("\
       --writefpevent            write progress to /tmp/flashplayer.event.\n"),
    N_("\
