...
#define MFC_GET_CONFIG_DEC_MP4ASP_FCODE					(0x0AA0C003)
#define MFC_GET_CONFIG_DEC_MP4ASP_VOP_TIME_RES			(0x0AA0C004)
#define MFC_GET_CONFIG_DEC_MP4ASP_TIME_BASE_LAST		(0x0AA0C005)
#define MFC_GET_CONFIG_DEC_MP4ASP_NONB_TIME_LAST		(0x0AA0C006)
#define MFC_GET_CONFIG_DEC_MP4ASP_TRD					(0x0AA0C007)
#define MFC_GET_CONFIG_DEC_BYTE_CONSUMED				(0x0AA0C008)
